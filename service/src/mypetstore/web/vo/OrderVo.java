/**
 * @{#} OrderVo.java Create on 2008-6-4 下午03:21:31
 *
...
public class OrderVo implements IViewObject {
	 ...
	 *            the shopping cart
	 */
	public void init(AccountVo account, CartVo cart) {
		...
		int i = 1;
		while (ite.hasNext()) {
			CartItemVo ci = (CartItemVo) ite.next();
			LineItemVo item = new LineItemVo();
