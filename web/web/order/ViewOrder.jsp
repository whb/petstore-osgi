...
<bean:define id="itemList" name="orderForm" property="order.lineItems"/>
...
<tr><td colspan="2">
  <table>
    ...
    <logic:iterate id="item" name="itemList">
      <tr>
        <td><html:link paramId="itemId" paramName="item" paramProperty="itemId" page="/shop/viewItem.shtml?method=viewItem">
        ...
        <td><bean:write name="item" property="totalPrice" format="$#,##0.00"/></td>
      </tr>
    </logic:iterate>
    <tr>
