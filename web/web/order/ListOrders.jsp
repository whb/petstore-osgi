...
<table>
  ...
  <logic:iterate id="order" name="orderForm" property="orderList">
    <tr>
      <td><html:link paramId="orderId" paramName="order" paramProperty="orderId" page="/shop/order.shtml?method=viewOrder">
