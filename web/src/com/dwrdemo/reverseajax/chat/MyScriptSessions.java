...
public class MyScriptSessions {
	...
	/**
	 * Utility to add the given script to all known browsers. This version
	 * automatically wraps the string in a ClientScript object.
	 * 
	 * @param scriptString
	 ...
	 * @param params
	 *            The parameters to the above function
	 */
